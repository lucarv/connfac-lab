...
For this lab we will implement the kappa architecture we done in the cloud, but we will be moving some of the work to the factory floor.  
For that we will deploy an Azure Edge Device.  
