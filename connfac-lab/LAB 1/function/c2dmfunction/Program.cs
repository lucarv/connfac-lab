...
public static async Task<HttpResponseMessage> Run(HttpRequestMessage req, TraceWriter log)
{
  try {   
    ...
    var connectionString = "HostName=elux-connfac-iothub.azure-devices.net;DeviceId=simulator;SharedAccessKey=Ysg2o9Fw9BMMcSQLcnmTOPTdnKMveNW1P1WG5vG/W9c=";
    ...
    var methodInvocation = new CloudToDeviceMethod("SwitchOff") { ResponseTimeout = TimeSpan.FromSeconds(10) };
