...
First we will pre-provision an EDGE device identity in IoT Hub, using symmetric keys generated by Azure (Note that this is not a best practice for production, we will do it for educational purposes only)  
